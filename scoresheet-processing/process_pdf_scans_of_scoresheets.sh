...
#   Build with maven : cd zxing-zxing-*; mvn install
#     https://github.com/zxing/zxing/wiki/Getting-Started-Developing#build
#   Create single jar : cd javase && mvn -DskipTests package assembly:single
...
#   and renames it to a filename containing the interpreted entrid prefix
